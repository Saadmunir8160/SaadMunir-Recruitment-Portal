    ...
    public partial class Test : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContactUsRequestId = table.Column<long>(type: "bigint", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_contactUsRequest", x => x.ContactUsRequestId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CoverageAreaId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoverageAreas", x => x.CoverageAreaId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CR_No = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    VAT_ID = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SettingsID = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SettingsGroup = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    SettingsKey = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    SettingsValue = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeneralSettings", x => x.SettingsID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FaxNo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    AnnualTurnover = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MajorCustomers = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TaxRegistrationNo = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    FilePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<bool>(type: "bit", nullable: false),
                    Quality = table.Column<bool>(type: "bit", nullable: false),
                    Delivery = table.Column<bool>(type: "bit", nullable: false),
                    Reference = table.Column<bool>(type: "bit", nullable: false),
                    LocationalSuitability = table.Column<bool>(type: "bit", nullable: false),
                    HSECompliance = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cities_CoverageAreas_CoverageAreaId",
                        column: x => x.CoverageAreaId,
                        principalTable: "CoverageAreas",
                        principalColumn: "CoverageAreaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCostPercentage = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_CoverageAreas_CoverageAreaId",
                        column: x => x.CoverageAreaId,
                        principalTable: "CoverageAreas",
                        principalColumn: "CoverageAreaId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Promotions_CoverageAreas_CoverageAreaId",
                        column: x => x.CoverageAreaId,
                        principalTable: "CoverageAreas",
                        principalColumn: "CoverageAreaId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobApplications", x => x.JobApplicationsId);
                    table.ForeignKey(
                        name: "FK_JobApplications_Jobs_JobsId",
                        column: x => x.JobsId,
                        principalTable: "Jobs",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Locations_CoverageAreas_CoverageAreaId",
                        column: x => x.CoverageAreaId,
                        principalTable: "CoverageAreas",
                        principalColumn: "CoverageAreaId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TrackingId = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    CustomerId = table.Column<long>(type: "bigint", nullable: false),
                    LocationId = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    ShipingCost = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GpsLocationId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GpsLocation", x => x.GpsLocationId);
                    table.ForeignKey(
                        name: "FK_GpsLocation_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cities_CoverageAreaId",
                table: "Cities",
                column: "CoverageAreaId");

            migrationBuilder.CreateIndex(
                name: "IX_GpsLocation_OrderId",
                table: "GpsLocation",
                column: "OrderId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_JobsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_CoverageAreaId",
                table: "Locations",
                column: "CoverageAreaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CoverageAreaId",
                table: "Products",
                column: "CoverageAreaId");

            migrationBuilder.CreateIndex(
                name: "IX_Promotions_CoverageAreaId",
                table: "Promotions",
                column: "CoverageAreaId");

            migrationBuilder.CreateIndex(
                name: "IX_Vendors_TaxRegistrationNo",
                table: "Vendors",
