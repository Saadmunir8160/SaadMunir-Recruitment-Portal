...
{
    public class DeactivateDealerVehicleCommand : IRequest<Response<bool>>
    {
        public int VehicleID { get; set; }
    }

    public class DeactivateDealerVehicleCommandHandler : IRequestHandler<DeactivateDealerVehicleCommand, Response<bool>>
    {
        ...
        public async Task<Response<bool>> Handle(DeactivateDealerVehicleCommand request, CancellationToken cancellationToken)
        {
            ...
            if (!entity.IsActive)
                return new Response<bool> { Success = false, Message = "Dealer vehicle is already inactive." };
            ...
            return new Response<bool> { Success = true, Data = true, Message = "Dealer vehicle deactivated successfully." };
        }
    }
}