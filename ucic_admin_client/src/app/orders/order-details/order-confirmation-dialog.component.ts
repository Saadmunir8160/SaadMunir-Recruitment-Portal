    ...
    <div class="confirmation-dialog">
      ...
      <div class="card-header bg-body border-0 rounded-top-4">
        <h5 class="card-title mb-0 fw-medium text-dark">
          <iconify-icon icon="solar:clipboard-check-broken" class="text-primary me-2"></iconify-icon>
          Confirm Order
        </h5>
      </div>
        ...
        <div class="text-center py-2">
          <div class="mb-2">
            <iconify-icon icon="solar:question-circle-broken" class="text-warning" style="font-size: 2.5rem;"></iconify-icon>
                     ...
                     <h6 class="fw-medium text-dark mb-1">Order Confirmation Required</h6>
           <p class="text-muted mb-0">Are you sure you want to confirm this order?</p>
